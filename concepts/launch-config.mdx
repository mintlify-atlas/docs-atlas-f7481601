---
title: "Configuring CUDA Kernel Launch Parameters in cudaz"
sidebarTitle: "Launch Config"
description: "LaunchConfig controls the CUDA kernel grid and block dimensions. Use for_num_elems() for 1D workloads or set grid_dim and block_dim for 2D and 3D layouts."
---
