...
<ParamField path="file_path" type="path.PathBuffer" required>
...
<ParamField path="cuda_slice" type="CudaSlice(data_type)" required>
...
<ParamField path="cuda_slice" type="CudaSliceR" required>
