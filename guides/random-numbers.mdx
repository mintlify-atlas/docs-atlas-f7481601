---
title: "GPU Random Number Generation with cuRAND and cudaz"
sidebarTitle: "Random Numbers"
description: "Generate large arrays of uniform random float values on the GPU using cudaz's Rng type, backed by NVIDIA's cuRAND library, without CPU round-trips."
---
